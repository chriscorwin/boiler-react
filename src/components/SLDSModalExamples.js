...
import {SLDSModal, SLDSButton, SLDSPicklistBase, SLDSLookup} from 'design-system-react';

export class SLDSModalExamples extends React.Component {
  ...
  render(){
   ...
   <div>
        <h4 className="slds-text-heading--medium slds-p-vertical--medium">Modals</h4>
