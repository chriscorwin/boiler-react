...
import {SLDSNotification, SLDSModal, SLDSButton} from 'design-system-react';

export class SLDSNotificationExamples extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="slds-p-vertical--medium demo">
        <h4 className="slds-text-heading--medium slds-p-vertical--medium">Notifications</h4>
